...
void jv_mainframe::DoSelectObject(Int_t id)
{
	...
	// Get pointer to selected object as a JObject
	v1720Object *obj2=0;
	obj2 = dynamic_cast<v1720Object*>((JObject*)vobjs[idx]);
	if (obj2!=0){
		DrawObject(obj2);
	}

	/*If the object was not a Object with its own draw method, try to check if there is a reference to another object that is a BDXObject*/
	else{
		vector<const v1720Object*> ptrs;
...
void jv_mainframe::DrawObject(const v1720Object *obj)
{
